...
def save_image():
    ...
    cap = cv2.VideoCapture(gstreamer_pipeline_5(flip_method=0, capture_height=2464, capture_width=3264, display_height=2464, display_width=3264, framerate=21), cv2.CAP_GSTREAMER)
    delay=100
    while(cap.isOpened()):
